...
void MapWindow::initializeGL() {
  ...
  QString MAPBOX_STYLE = QString::fromStdString(Params().get("KISAMapboxStyleSelect"));
  ...
  if (MAPBOX_STYLE == "0") {
    ...
    m_map->setStyleUrl("mapbox://styles/multikyd/ckwbf0oig3swu14lc482wqvfz"); // kisapilot
