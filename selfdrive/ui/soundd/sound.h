...
const std::tuple<AudibleAlert, QString, int, float> sound_list[] = {
  ...
  {AudibleAlert::WARNING_IMMEDIATE, "warning_immediate.wav", 8, MAX_VOLUME},
  {AudibleAlert::WARNING, "warning.wav", 0, MAX_VOLUME},
  {AudibleAlert::DINGDONG, "dingdong.wav", 0, MAX_VOLUME},
};
